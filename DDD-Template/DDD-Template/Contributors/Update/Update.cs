...
using DDD_Template.Application.Contributors.Get;
using DDD_Template.Application.Contributors.Update;
using FastEndpoints;
using MediatR;
...
namespace DDD_Template.Contributors.Update
{
    ...
    /// </remarks>
    public class Update(IMediator _mediator) : Endpoint<UpdateContributorRequest, UpdateContributorResponse>
    {
